  ...
  return (
    ...
    <div className='text-center mt-8 mb-10'>
     ...
     <div className="space-x-2 text-center mt-6">
        <button onClick={handlePrev} className="bg-[#000] text-[#fff] py-2 px-4 rounded-[10px] cursor-pointer"
          disabled={translateX === 0}>Prev</button>
        <button onClick={handleNext} className="bg-[#000] text-[#fff] py-2 px-4 rounded-[10px] cursor-pointer"
